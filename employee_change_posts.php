            ...
            <div class="portlet-body">  
              ...
              <form action="scripts/change_post_employee.php" data-validate="parsley" class="form parsley-form">
                ...
                <div class="form-group hide-and-show">  
                  ...
                  <input type="text" id="edu_qual" name="educational_qualifications" class="form-control parsley-validated" data-required="true">
                </div> <!-- /.form-group -->

                <div class="form-group hide-and-show">
                  <label for="user_id">User ID</label>
                  <input type="text" id="user_id" name="user_id" class="form-control parsley-validated" data-required="true">
                </div> <!-- /.form-group -->
